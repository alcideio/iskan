...
func (r ApiListApiVersionResourcesRequest) Execute() (DiscoverableLinks, *_nethttp.Response, error) {
	return r.ApiService.ListApiVersionResourcesExecute(r)
}

/*
 * ListApiVersionResources API Version Resources
 * Returns a listing of resources (endpoints) available in a version of the API. Each link returned indicates an endpoint available in the API, with the supported verbs.
 ...
 * @return ApiListApiVersionResourcesRequest
 */
 ...
 * @return DiscoverableLinks
 */
func (a *DiscoveryApiService) ListApiVersionResourcesExecute(r ApiListApiVersionResourcesRequest) (DiscoverableLinks, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  DiscoverableLinks
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DiscoveryApiService.ListApiVersionResources")
	if err != nil {
