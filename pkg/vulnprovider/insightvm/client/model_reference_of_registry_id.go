...
// NewReferenceOfRegistryId instantiates a new ReferenceOfRegistryId object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewReferenceOfRegistryId() *ReferenceOfRegistryId {
	this := ReferenceOfRegistryId{}
	return &this
}

// NewReferenceOfRegistryIdWithDefaults instantiates a new ReferenceOfRegistryId object
...
type NullableReferenceOfRegistryId struct {
	value *ReferenceOfRegistryId
	isSet bool
}

func (v NullableReferenceOfRegistryId) Get() *ReferenceOfRegistryId {
	return v.value
}

func (v *NullableReferenceOfRegistryId) Set(val *ReferenceOfRegistryId) {
	v.value = val
	v.isSet = true
}

func (v NullableReferenceOfRegistryId) IsSet() bool {
	return v.isSet
}
...
func NewNullableReferenceOfRegistryId(val *ReferenceOfRegistryId) *NullableReferenceOfRegistryId {
	return &NullableReferenceOfRegistryId{value: val, isSet: true}
}
