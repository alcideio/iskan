 ...
 * @return Image
 */
func (a *ContainerApiService) GetImageExecute(r ApiGetImageRequest) (Image, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContainerApiService.GetImage")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/experimental/images/{id}"
...
func (r ApiGetRegistryRepositoryImagesRequest) Assessed(assessed bool) ApiGetRegistryRepositoryImagesRequest {
	r.assessed = &assessed
	return r
}
func (r ApiGetRegistryRepositoryImagesRequest) Page(page int32) ApiGetRegistryRepositoryImagesRequest {
	r.page = &page
	return r
}
func (r ApiGetRegistryRepositoryImagesRequest) Size(size int32) ApiGetRegistryRepositoryImagesRequest {
	r.size = &size
	return r
}
func (r ApiGetRegistryRepositoryImagesRequest) Sort(sort string) ApiGetRegistryRepositoryImagesRequest {
	r.sort = &sort
	return r
}

func (r ApiGetRegistryRepositoryImagesRequest) Execute() (PageOfRepositoryImageSummary, *_nethttp.Response, error) {
	return r.ApiService.GetRegistryRepositoryImagesExecute(r)
}
...
/*
 * Execute executes the request
 * @return PageOfRepositoryImageSummary
 */
func (a *ContainerApiService) GetRegistryRepositoryImagesExecute(r ApiGetRegistryRepositoryImagesRequest) (PageOfRepositoryImageSummary, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PageOfRepositoryImageSummary
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContainerApiService.GetRegistryRepositoryImages")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/experimental/registries/{registry_id}/repositories/{repository_id}/images"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.PathEscape(parameterToString(r.region, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"registry_id"+"}", _neturl.PathEscape(parameterToString(r.registryId, "")), -1)
	...
	if r.assessed != nil {
		localVarQueryParams.Add("assessed", parameterToString(*r.assessed, ""))
	}
	if r.page != nil {
...
func (r ApiSaveImageRequest) Execute() (ReferenceOfImageId, *_nethttp.Response, error) {
	return r.ApiService.SaveImageExecute(r)
}
...
*/
func (a *ContainerApiService) SaveImage(ctx _context.Context, region Region) ApiSaveImageRequest {
	return ApiSaveImageRequest{
		ApiService: a,
		ctx:        ctx,
		region:     region,
...
/*
 * Execute executes the request
 * @return ReferenceOfImageId
 */
func (a *ContainerApiService) SaveImageExecute(r ApiSaveImageRequest) (ReferenceOfImageId, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ReferenceOfImageId
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContainerApiService.SaveImage")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/experimental/images"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.PathEscape(parameterToString(r.region, "")), -1)
	...
	localVarFormParams := _neturl.Values{}
	if r.imageEdit == nil {
		return localVarReturnValue, nil, reportError("imageEdit is required and must be specified")
	}
