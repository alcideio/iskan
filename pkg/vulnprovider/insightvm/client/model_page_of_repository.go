...
// NewPageOfRepository instantiates a new PageOfRepository object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPageOfRepository() *PageOfRepository {
	this := PageOfRepository{}
	return &this
}

// NewPageOfRepositoryWithDefaults instantiates a new PageOfRepository object
...
type NullablePageOfRepository struct {
	value *PageOfRepository
	isSet bool
}

func (v NullablePageOfRepository) Get() *PageOfRepository {
	return v.value
}

func (v *NullablePageOfRepository) Set(val *PageOfRepository) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePageOfRepository(val *PageOfRepository) *NullablePageOfRepository {
	return &NullablePageOfRepository{value: val, isSet: true}
}
