...
func (o *RegistryConfiguration) GetAssessOnSync() bool {
	if o == nil || o.AssessOnSync == nil {
		var ret bool
		return ret
	}
	return *o.AssessOnSync
}

// GetAssessOnSyncOk returns a tuple with the AssessOnSync field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RegistryConfiguration) GetAssessOnSyncOk() (*bool, bool) {
	if o == nil || o.AssessOnSync == nil {
		return nil, false
	}
	return o.AssessOnSync, true
}
...
func (o *RegistryConfiguration) GetQuayOrganization() string {
	if o == nil || o.QuayOrganization == nil {
		var ret string
		return ret
	}
	return *o.QuayOrganization
}

// GetQuayOrganizationOk returns a tuple with the QuayOrganization field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RegistryConfiguration) GetQuayOrganizationOk() (*string, bool) {
	if o == nil || o.QuayOrganization == nil {
		return nil, false
	}
	return o.QuayOrganization, true
}
...
func (o RegistryConfiguration) MarshalJSON() ([]byte, error) {
	...
	if o.AssessOnSync != nil {
		toSerialize["assess_on_sync"] = o.AssessOnSync
	}
	if o.ConfigurationType != nil {
		toSerialize["configuration_type"] = o.ConfigurationType
	}
	...
	if o.QuayOrganization != nil {
		toSerialize["quay_organization"] = o.QuayOrganization
	}
	if o.Repository != nil {
