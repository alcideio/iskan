...
// NewStandardReference instantiates a new StandardReference object
...
// NewStandardReferenceWithDefaults instantiates a new StandardReference object
...
func (o *StandardReference) GetStandardTitle() string {
	if o == nil || o.StandardTitle == nil {
		var ret string
		return ret
	}
	return *o.StandardTitle
}

// GetStandardTitleOk returns a tuple with the StandardTitle field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StandardReference) GetStandardTitleOk() (*string, bool) {
	if o == nil || o.StandardTitle == nil {
		return nil, false
	}
	return o.StandardTitle, true
}
...
func (o StandardReference) MarshalJSON() ([]byte, error) {
	...
	if o.StandardTitle != nil {
		toSerialize["standard_title"] = o.StandardTitle
	}
	if o.Threats != nil {
...
func (v NullableStandardReference) Get() *StandardReference {
	return v.value
}

func (v *NullableStandardReference) Set(val *StandardReference) {
	v.value = val
	v.isSet = true
}
...
func NewNullableStandardReference(val *StandardReference) *NullableStandardReference {
	return &NullableStandardReference{value: val, isSet: true}
}
