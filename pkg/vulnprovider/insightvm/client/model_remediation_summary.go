...
// NewRemediationSummary instantiates a new RemediationSummary object
...
// NewRemediationSummaryWithDefaults instantiates a new RemediationSummary object
...
func (o *RemediationSummary) GetRemediations() []TemplatizedRemediation {
	if o == nil || o.Remediations == nil {
		var ret []TemplatizedRemediation
		return ret
	}
...
func (v NullableRemediationSummary) Get() *RemediationSummary {
	return v.value
}

func (v *NullableRemediationSummary) Set(val *RemediationSummary) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRemediationSummary(val *RemediationSummary) *NullableRemediationSummary {
	return &NullableRemediationSummary{value: val, isSet: true}
}
