...
// NewRepositoryReference instantiates a new RepositoryReference object
...
// NewRepositoryReferenceWithDefaults instantiates a new RepositoryReference object
...
func (v NullableRepositoryReference) Get() *RepositoryReference {
	return v.value
}

func (v *NullableRepositoryReference) Set(val *RepositoryReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoryReference) IsSet() bool {
	return v.isSet
}
...
func NewNullableRepositoryReference(val *RepositoryReference) *NullableRepositoryReference {
	return &NullableRepositoryReference{value: val, isSet: true}
}
