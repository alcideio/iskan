...
// NewReferenceOfAwsAccountId instantiates a new ReferenceOfAwsAccountId object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewReferenceOfAwsAccountId() *ReferenceOfAwsAccountId {
	this := ReferenceOfAwsAccountId{}
	return &this
}

// NewReferenceOfAwsAccountIdWithDefaults instantiates a new ReferenceOfAwsAccountId object
...
type NullableReferenceOfAwsAccountId struct {
	value *ReferenceOfAwsAccountId
	isSet bool
}

func (v NullableReferenceOfAwsAccountId) Get() *ReferenceOfAwsAccountId {
	return v.value
}

func (v *NullableReferenceOfAwsAccountId) Set(val *ReferenceOfAwsAccountId) {
	v.value = val
	v.isSet = true
}

func (v NullableReferenceOfAwsAccountId) IsSet() bool {
	return v.isSet
}

func (v *NullableReferenceOfAwsAccountId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReferenceOfAwsAccountId(val *ReferenceOfAwsAccountId) *NullableReferenceOfAwsAccountId {
	return &NullableReferenceOfAwsAccountId{value: val, isSet: true}
}
