...
// NewNewImageBuild instantiates a new NewImageBuild object
...
// NewNewImageBuildWithDefaults instantiates a new NewImageBuild object
...
func (v NullableNewImageBuild) Get() *NewImageBuild {
	return v.value
}
...
func NewNullableNewImageBuild(val *NewImageBuild) *NullableNewImageBuild {
	return &NullableNewImageBuild{value: val, isSet: true}
}
