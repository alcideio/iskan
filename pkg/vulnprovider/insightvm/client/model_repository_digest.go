...
// NewRepositoryDigest instantiates a new RepositoryDigest object
...
// NewRepositoryDigestWithDefaults instantiates a new RepositoryDigest object
...
type NullableRepositoryDigest struct {
	value *RepositoryDigest
	isSet bool
}

func (v NullableRepositoryDigest) Get() *RepositoryDigest {
	return v.value
}

func (v *NullableRepositoryDigest) Set(val *RepositoryDigest) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRepositoryDigest(val *RepositoryDigest) *NullableRepositoryDigest {
	return &NullableRepositoryDigest{value: val, isSet: true}
}
