...
// NewLayerEdit instantiates a new LayerEdit object
...
// NewLayerEditWithDefaults instantiates a new LayerEdit object
...
func NewNullableLayerEdit(val *LayerEdit) *NullableLayerEdit {
	return &NullableLayerEdit{value: val, isSet: true}
}
