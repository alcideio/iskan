...
// NewRuleExceptionSummary instantiates a new RuleExceptionSummary object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRuleExceptionSummary() *RuleExceptionSummary {
	this := RuleExceptionSummary{}
	return &this
}

// NewRuleExceptionSummaryWithDefaults instantiates a new RuleExceptionSummary object
...
func (o *RuleExceptionSummary) GetExpirationState() string {
	if o == nil || o.ExpirationState == nil {
		var ret string
		return ret
	}
	return *o.ExpirationState
}

// GetExpirationStateOk returns a tuple with the ExpirationState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RuleExceptionSummary) GetExpirationStateOk() (*string, bool) {
	if o == nil || o.ExpirationState == nil {
		return nil, false
	}
	return o.ExpirationState, true
}
...
func (o RuleExceptionSummary) MarshalJSON() ([]byte, error) {
	...
	if o.ExpirationState != nil {
		toSerialize["expiration_state"] = o.ExpirationState
	}
	if o.Metrics != nil {
...
type NullableRuleExceptionSummary struct {
	value *RuleExceptionSummary
	isSet bool
}

func (v NullableRuleExceptionSummary) Get() *RuleExceptionSummary {
	return v.value
}

func (v *NullableRuleExceptionSummary) Set(val *RuleExceptionSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleExceptionSummary) IsSet() bool {
	return v.isSet
}
...
func NewNullableRuleExceptionSummary(val *RuleExceptionSummary) *NullableRuleExceptionSummary {
	return &NullableRuleExceptionSummary{value: val, isSet: true}
}
