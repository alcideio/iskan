...
// NewImageDigest instantiates a new ImageDigest object
...
// NewImageDigestWithDefaults instantiates a new ImageDigest object
...
func (v NullableImageDigest) Get() *ImageDigest {
	return v.value
}
...
func NewNullableImageDigest(val *ImageDigest) *NullableImageDigest {
	return &NullableImageDigest{value: val, isSet: true}
}
