...
// GetFirstFailureOk returns a tuple with the FirstFailure field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuthenticationError) GetFirstFailureOk() (*string, bool) {
	if o == nil || o.FirstFailure == nil {
		return nil, false
	}
	return o.FirstFailure, true
}
...
func (o AuthenticationError) MarshalJSON() ([]byte, error) {
	...
	if o.FirstFailure != nil {
		toSerialize["first_failure"] = o.FirstFailure
	}
