...
func (o *Rule) GetVulnerabilityIds() []string {
	if o == nil || o.VulnerabilityIds == nil {
		var ret []string
		return ret
	}
...
func (o Rule) MarshalJSON() ([]byte, error) {
	...
	if o.PackageIds != nil {
		toSerialize["package_ids"] = o.PackageIds
	}
	if o.Status != nil {
		toSerialize["status"] = o.Status
	}
	if o.VulnerabilityIds != nil {
