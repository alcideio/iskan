...
// NewHealthSummary instantiates a new HealthSummary object
...
// NewHealthSummaryWithDefaults instantiates a new HealthSummary object
...
func (o HealthSummary) MarshalJSON() ([]byte, error) {
	...
	if o.OutOfService != nil {
		toSerialize["out_of_service"] = o.OutOfService
	}
	if o.Unknown != nil {
...
func (v NullableHealthSummary) Get() *HealthSummary {
	return v.value
}
...
func NewNullableHealthSummary(val *HealthSummary) *NullableHealthSummary {
	return &NullableHealthSummary{value: val, isSet: true}
}
