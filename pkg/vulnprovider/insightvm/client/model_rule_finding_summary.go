...
// NewRuleFindingSummary instantiates a new RuleFindingSummary object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRuleFindingSummary() *RuleFindingSummary {
	this := RuleFindingSummary{}
	return &this
}

// NewRuleFindingSummaryWithDefaults instantiates a new RuleFindingSummary object
...
type NullableRuleFindingSummary struct {
	value *RuleFindingSummary
	isSet bool
}

func (v NullableRuleFindingSummary) Get() *RuleFindingSummary {
	return v.value
}

func (v *NullableRuleFindingSummary) Set(val *RuleFindingSummary) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRuleFindingSummary(val *RuleFindingSummary) *NullableRuleFindingSummary {
	return &NullableRuleFindingSummary{value: val, isSet: true}
}
