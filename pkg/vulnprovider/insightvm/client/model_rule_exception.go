...
// NewRuleException instantiates a new RuleException object
...
// NewRuleExceptionWithDefaults instantiates a new RuleException object
...
func (v NullableRuleException) Get() *RuleException {
	return v.value
}
...
func NewNullableRuleException(val *RuleException) *NullableRuleException {
	return &NullableRuleException{value: val, isSet: true}
}
