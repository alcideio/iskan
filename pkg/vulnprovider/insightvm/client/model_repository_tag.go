...
// NewRepositoryTag instantiates a new RepositoryTag object
...
// NewRepositoryTagWithDefaults instantiates a new RepositoryTag object
...
func (v NullableRepositoryTag) Get() *RepositoryTag {
	return v.value
}
...
func NewNullableRepositoryTag(val *RepositoryTag) *NullableRepositoryTag {
	return &NullableRepositoryTag{value: val, isSet: true}
}
