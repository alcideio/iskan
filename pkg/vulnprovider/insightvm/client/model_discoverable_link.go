...
// NewDiscoverableLink instantiates a new DiscoverableLink object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDiscoverableLink() *DiscoverableLink {
	this := DiscoverableLink{}
	return &this
}

// NewDiscoverableLinkWithDefaults instantiates a new DiscoverableLink object
...
type NullableDiscoverableLink struct {
	value *DiscoverableLink
	isSet bool
}

func (v NullableDiscoverableLink) Get() *DiscoverableLink {
	return v.value
}

func (v *NullableDiscoverableLink) Set(val *DiscoverableLink) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDiscoverableLink(val *DiscoverableLink) *NullableDiscoverableLink {
	return &NullableDiscoverableLink{value: val, isSet: true}
}
