...
func (o *Repository) GetImageDigests() []ImageDigest {
	if o == nil || o.ImageDigests == nil {
		var ret []ImageDigest
		return ret
	}
	return *o.ImageDigests
}

// GetImageDigestsOk returns a tuple with the ImageDigests field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Repository) GetImageDigestsOk() (*[]ImageDigest, bool) {
	if o == nil || o.ImageDigests == nil {
		return nil, false
	}
	return o.ImageDigests, true
}
...
func (o Repository) MarshalJSON() ([]byte, error) {
	...
	if o.ImageDigests != nil {
		toSerialize["image_digests"] = o.ImageDigests
	}
	if o.LastSync != nil {
