...
// NewReferenceOfImageId instantiates a new ReferenceOfImageId object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewReferenceOfImageId() *ReferenceOfImageId {
	this := ReferenceOfImageId{}
	return &this
}

// NewReferenceOfImageIdWithDefaults instantiates a new ReferenceOfImageId object
...
type NullableReferenceOfImageId struct {
	value *ReferenceOfImageId
	isSet bool
}

func (v NullableReferenceOfImageId) Get() *ReferenceOfImageId {
	return v.value
}

func (v *NullableReferenceOfImageId) Set(val *ReferenceOfImageId) {
	v.value = val
	v.isSet = true
}
...
func NewNullableReferenceOfImageId(val *ReferenceOfImageId) *NullableReferenceOfImageId {
	return &NullableReferenceOfImageId{value: val, isSet: true}
}
