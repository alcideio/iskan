...
// NewPageOfRegistry instantiates a new PageOfRegistry object
...
// NewPageOfRegistryWithDefaults instantiates a new PageOfRegistry object
...
type NullablePageOfRegistry struct {
	value *PageOfRegistry
	isSet bool
}

func (v NullablePageOfRegistry) Get() *PageOfRegistry {
	return v.value
}

func (v *NullablePageOfRegistry) Set(val *PageOfRegistry) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePageOfRegistry(val *PageOfRegistry) *NullablePageOfRegistry {
	return &NullablePageOfRegistry{value: val, isSet: true}
}
