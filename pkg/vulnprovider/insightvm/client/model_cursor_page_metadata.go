...
// NewCursorPageMetadata instantiates a new CursorPageMetadata object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCursorPageMetadata() *CursorPageMetadata {
	this := CursorPageMetadata{}
	return &this
}

// NewCursorPageMetadataWithDefaults instantiates a new CursorPageMetadata object
...
func (o CursorPageMetadata) MarshalJSON() ([]byte, error) {
	...
	if o.TotalResources != nil {
		toSerialize["total_resources"] = o.TotalResources
	}
	return json.Marshal(toSerialize)
}

type NullableCursorPageMetadata struct {
	value *CursorPageMetadata
	isSet bool
}

func (v NullableCursorPageMetadata) Get() *CursorPageMetadata {
	return v.value
}

func (v *NullableCursorPageMetadata) Set(val *CursorPageMetadata) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCursorPageMetadata(val *CursorPageMetadata) *NullableCursorPageMetadata {
	return &NullableCursorPageMetadata{value: val, isSet: true}
}
