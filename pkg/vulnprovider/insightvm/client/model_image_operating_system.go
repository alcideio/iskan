...
// NewImageOperatingSystem instantiates a new ImageOperatingSystem object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewImageOperatingSystem() *ImageOperatingSystem {
	this := ImageOperatingSystem{}
	return &this
}

// NewImageOperatingSystemWithDefaults instantiates a new ImageOperatingSystem object
...
type NullableImageOperatingSystem struct {
	value *ImageOperatingSystem
	isSet bool
}

func (v NullableImageOperatingSystem) Get() *ImageOperatingSystem {
	return v.value
}

func (v *NullableImageOperatingSystem) Set(val *ImageOperatingSystem) {
	v.value = val
	v.isSet = true
}

func (v NullableImageOperatingSystem) IsSet() bool {
	return v.isSet
}
...
func NewNullableImageOperatingSystem(val *ImageOperatingSystem) *NullableImageOperatingSystem {
	return &NullableImageOperatingSystem{value: val, isSet: true}
}
