...
// NewRepositoryTagReference instantiates a new RepositoryTagReference object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRepositoryTagReference() *RepositoryTagReference {
	this := RepositoryTagReference{}
	return &this
}

// NewRepositoryTagReferenceWithDefaults instantiates a new RepositoryTagReference object
...
type NullableRepositoryTagReference struct {
	value *RepositoryTagReference
	isSet bool
}

func (v NullableRepositoryTagReference) Get() *RepositoryTagReference {
	return v.value
}

func (v *NullableRepositoryTagReference) Set(val *RepositoryTagReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoryTagReference) IsSet() bool {
	return v.isSet
}
...
func NewNullableRepositoryTagReference(val *RepositoryTagReference) *NullableRepositoryTagReference {
	return &NullableRepositoryTagReference{value: val, isSet: true}
}
