...
// NewInfrastructureEntityId instantiates a new InfrastructureEntityId object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInfrastructureEntityId() *InfrastructureEntityId {
	this := InfrastructureEntityId{}
	return &this
}

// NewInfrastructureEntityIdWithDefaults instantiates a new InfrastructureEntityId object
...
type NullableInfrastructureEntityId struct {
	value *InfrastructureEntityId
	isSet bool
}

func (v NullableInfrastructureEntityId) Get() *InfrastructureEntityId {
	return v.value
}

func (v *NullableInfrastructureEntityId) Set(val *InfrastructureEntityId) {
	v.value = val
	v.isSet = true
}

func (v NullableInfrastructureEntityId) IsSet() bool {
	return v.isSet
}
...
func NewNullableInfrastructureEntityId(val *InfrastructureEntityId) *NullableInfrastructureEntityId {
	return &NullableInfrastructureEntityId{value: val, isSet: true}
}
