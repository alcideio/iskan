...
// NewTemplatizedRemediation instantiates a new TemplatizedRemediation object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplatizedRemediation() *TemplatizedRemediation {
	this := TemplatizedRemediation{}
	return &this
}

// NewTemplatizedRemediationWithDefaults instantiates a new TemplatizedRemediation object
...
type NullableTemplatizedRemediation struct {
	value *TemplatizedRemediation
	isSet bool
}

func (v NullableTemplatizedRemediation) Get() *TemplatizedRemediation {
	return v.value
}

func (v *NullableTemplatizedRemediation) Set(val *TemplatizedRemediation) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplatizedRemediation) IsSet() bool {
	return v.isSet
}
...
func NewNullableTemplatizedRemediation(val *TemplatizedRemediation) *NullableTemplatizedRemediation {
	return &NullableTemplatizedRemediation{value: val, isSet: true}
}
