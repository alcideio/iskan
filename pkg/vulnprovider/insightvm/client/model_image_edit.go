...
// NewImageEdit instantiates a new ImageEdit object
...
// NewImageEditWithDefaults instantiates a new ImageEdit object
...
func NewNullableImageEdit(val *ImageEdit) *NullableImageEdit {
	return &NullableImageEdit{value: val, isSet: true}
}
