...
// NewTermAggregate instantiates a new TermAggregate object
...
// NewTermAggregateWithDefaults instantiates a new TermAggregate object
...
func (v NullableTermAggregate) Get() *TermAggregate {
	return v.value
}
...
func NewNullableTermAggregate(val *TermAggregate) *NullableTermAggregate {
	return &NullableTermAggregate{value: val, isSet: true}
}
