...
// NewDockerfileCommand instantiates a new DockerfileCommand object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDockerfileCommand() *DockerfileCommand {
	this := DockerfileCommand{}
	return &this
}

// NewDockerfileCommandWithDefaults instantiates a new DockerfileCommand object
...
type NullableDockerfileCommand struct {
	value *DockerfileCommand
	isSet bool
}

func (v NullableDockerfileCommand) Get() *DockerfileCommand {
	return v.value
}

func (v *NullableDockerfileCommand) Set(val *DockerfileCommand) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDockerfileCommand(val *DockerfileCommand) *NullableDockerfileCommand {
	return &NullableDockerfileCommand{value: val, isSet: true}
}
