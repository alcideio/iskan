...
// NewRuleFinding instantiates a new RuleFinding object
...
// NewRuleFindingWithDefaults instantiates a new RuleFinding object
...
func (o *RuleFinding) GetEntityId() InfrastructureEntityId {
	if o == nil || o.EntityId == nil {
		var ret InfrastructureEntityId
		return ret
	}
	return *o.EntityId
}
...
func (o *RuleFinding) GetFailedSince() string {
	if o == nil || o.FailedSince == nil {
		var ret string
		return ret
	}
	return *o.FailedSince
}

// GetFailedSinceOk returns a tuple with the FailedSince field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RuleFinding) GetFailedSinceOk() (*string, bool) {
	if o == nil || o.FailedSince == nil {
		return nil, false
	}
	return o.FailedSince, true
}
...
func (o *RuleFinding) GetFirstEvaluated() string {
	if o == nil || o.FirstEvaluated == nil {
		var ret string
		return ret
	}
	return *o.FirstEvaluated
}

// GetFirstEvaluatedOk returns a tuple with the FirstEvaluated field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RuleFinding) GetFirstEvaluatedOk() (*string, bool) {
	if o == nil || o.FirstEvaluated == nil {
		return nil, false
	}
	return o.FirstEvaluated, true
}
...
func (o RuleFinding) MarshalJSON() ([]byte, error) {
	...
	if o.FailedSince != nil {
		toSerialize["failed_since"] = o.FailedSince
	}
	if o.FirstEvaluated != nil {
		toSerialize["first_evaluated"] = o.FirstEvaluated
	}
	if o.Id != nil {
		toSerialize["id"] = o.Id
	}
...
func (v NullableRuleFinding) Get() *RuleFinding {
	return v.value
}
...
func NewNullableRuleFinding(val *RuleFinding) *NullableRuleFinding {
	return &NullableRuleFinding{value: val, isSet: true}
}
