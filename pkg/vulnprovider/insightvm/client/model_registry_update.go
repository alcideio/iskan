...
// NewRegistryUpdate instantiates a new RegistryUpdate object
...
// NewRegistryUpdateWithDefaults instantiates a new RegistryUpdate object
...
func (v NullableRegistryUpdate) Get() *RegistryUpdate {
	return v.value
}

func (v *NullableRegistryUpdate) Set(val *RegistryUpdate) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRegistryUpdate(val *RegistryUpdate) *NullableRegistryUpdate {
	return &NullableRegistryUpdate{value: val, isSet: true}
}
