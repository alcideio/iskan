...
// NewImageAssessmentResult instantiates a new ImageAssessmentResult object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewImageAssessmentResult() *ImageAssessmentResult {
	this := ImageAssessmentResult{}
	return &this
}

// NewImageAssessmentResultWithDefaults instantiates a new ImageAssessmentResult object
...
func (o *ImageAssessmentResult) GetVulnerabilityId() string {
	if o == nil || o.VulnerabilityId == nil {
		var ret string
		return ret
	}
...
type NullableImageAssessmentResult struct {
	value *ImageAssessmentResult
	isSet bool
}

func (v NullableImageAssessmentResult) Get() *ImageAssessmentResult {
	return v.value
}

func (v *NullableImageAssessmentResult) Set(val *ImageAssessmentResult) {
	v.value = val
	v.isSet = true
}

func (v NullableImageAssessmentResult) IsSet() bool {
	return v.isSet
}
...
func NewNullableImageAssessmentResult(val *ImageAssessmentResult) *NullableImageAssessmentResult {
	return &NullableImageAssessmentResult{value: val, isSet: true}
}
