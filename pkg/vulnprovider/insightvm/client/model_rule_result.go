...
func (o *RuleResult) GetLocalizationPrefix() string {
	if o == nil || o.LocalizationPrefix == nil {
		var ret string
		return ret
	}
	return *o.LocalizationPrefix
}

// GetLocalizationPrefixOk returns a tuple with the LocalizationPrefix field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RuleResult) GetLocalizationPrefixOk() (*string, bool) {
	if o == nil || o.LocalizationPrefix == nil {
		return nil, false
	}
	return o.LocalizationPrefix, true
}
...
func (o RuleResult) MarshalJSON() ([]byte, error) {
	...
	if o.LocalizationPrefix != nil {
		toSerialize["localization_prefix"] = o.LocalizationPrefix
	}
	if o.ResultId != nil {
