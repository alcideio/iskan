...
// NewImageAssessment instantiates a new ImageAssessment object
...
// NewImageAssessmentWithDefaults instantiates a new ImageAssessment object
...
func (o *ImageAssessment) GetExploitability() ImageVulnerabilityExploitability {
	if o == nil || o.Exploitability == nil {
		var ret ImageVulnerabilityExploitability
		return ret
	}
...
func (o *ImageAssessment) GetFindings() []PackageVulnerabilityEvaluation {
...
func (o *ImageAssessment) GetVulnerabilities() ImageVulnerabilityCount {
	if o == nil || o.Vulnerabilities == nil {
		var ret ImageVulnerabilityCount
		return ret
	}
...
type NullableImageAssessment struct {
	value *ImageAssessment
	isSet bool
}

func (v NullableImageAssessment) Get() *ImageAssessment {
	return v.value
}

func (v *NullableImageAssessment) Set(val *ImageAssessment) {
	v.value = val
	v.isSet = true
}
...
func NewNullableImageAssessment(val *ImageAssessment) *NullableImageAssessment {
	return &NullableImageAssessment{value: val, isSet: true}
}
