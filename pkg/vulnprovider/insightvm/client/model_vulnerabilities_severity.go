...
// NewVulnerabilitiesSeverity instantiates a new VulnerabilitiesSeverity object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewVulnerabilitiesSeverity() *VulnerabilitiesSeverity {
	this := VulnerabilitiesSeverity{}
	return &this
}

// NewVulnerabilitiesSeverityWithDefaults instantiates a new VulnerabilitiesSeverity object
...
type NullableVulnerabilitiesSeverity struct {
	value *VulnerabilitiesSeverity
	isSet bool
}

func (v NullableVulnerabilitiesSeverity) Get() *VulnerabilitiesSeverity {
	return v.value
}

func (v *NullableVulnerabilitiesSeverity) Set(val *VulnerabilitiesSeverity) {
	v.value = val
	v.isSet = true
}

func (v NullableVulnerabilitiesSeverity) IsSet() bool {
	return v.isSet
}

func (v *NullableVulnerabilitiesSeverity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVulnerabilitiesSeverity(val *VulnerabilitiesSeverity) *NullableVulnerabilitiesSeverity {
	return &NullableVulnerabilitiesSeverity{value: val, isSet: true}
}
