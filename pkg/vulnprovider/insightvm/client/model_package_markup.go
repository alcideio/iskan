...
// NewPackageMarkup instantiates a new PackageMarkup object
...
// NewPackageMarkupWithDefaults instantiates a new PackageMarkup object
...
func (v NullablePackageMarkup) Get() *PackageMarkup {
	return v.value
}
...
func NewNullablePackageMarkup(val *PackageMarkup) *NullablePackageMarkup {
	return &NullablePackageMarkup{value: val, isSet: true}
}
