...
// NewReferenceOfBuildId instantiates a new ReferenceOfBuildId object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewReferenceOfBuildId() *ReferenceOfBuildId {
	this := ReferenceOfBuildId{}
	return &this
}

// NewReferenceOfBuildIdWithDefaults instantiates a new ReferenceOfBuildId object
...
type NullableReferenceOfBuildId struct {
	value *ReferenceOfBuildId
	isSet bool
}

func (v NullableReferenceOfBuildId) Get() *ReferenceOfBuildId {
	return v.value
}

func (v *NullableReferenceOfBuildId) Set(val *ReferenceOfBuildId) {
	v.value = val
	v.isSet = true
}
...
func NewNullableReferenceOfBuildId(val *ReferenceOfBuildId) *NullableReferenceOfBuildId {
	return &NullableReferenceOfBuildId{value: val, isSet: true}
}
