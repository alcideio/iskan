        ...
        <div>
          <span>
            <p className="text-secondary" style={{ "fontFamily": 'Roboto', "fontWeight": 300, "fontStyle": "thin", "fontSize": "16px" }}>
              Brought to You by <a href="https://www.alcide.io">Alcide's</a> Kubernetes Security Obsession
            </p>
          </span>
          <span>
            <p className="text-primary" style={{ "fontFamily": 'Source Code Pro', "fontWeight": 100, "fontStyle": "thin", "fontSize": "12px" }}>
              A Kubernetes Native Image Vulnerability Scanner By <a href="https://www.alcide.io">Alcide</a>
            </p>
            <p>
              <a href="https://www.alcide.io/kubernetes-advisor">
                <img src="https://github.com/alcideio/iskan/raw/master/iskan.png" alt="" height="128" />
              </a>
            </p>
          </span>
        </div>
